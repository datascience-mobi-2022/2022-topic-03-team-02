...
First, a major source of uncertainty lies in the way we decided to choose our criteria for RNA-dependent proteins. Here, we left local maxima unconsidered and instead only focused on global maxima in protein amount. This allowed for a more simplified definition of selection criteria but disregarded other shifts in protein amount that might be equally as relevant. Also, we decided against a smoothing of our distribution of protein amount, e.g. using Gaussian fits or other filters. Therefore, we interpreted the pattern in protein amount only through the constructed lens of 25 discrete fractions and thus missed possible effects that could lie in between two fractions (e.g., due to smoothing, the position of the global maximum changed from fraction 15 to a continuous value of 15.4, which would be the more realistic way to look at it). Similarly, we computed the shift in position of the global maximum between control and RNase using the difference in the mean position of the global maximum for both conditions. Proceeding as such may be accurate in some cases but is very likely to distort our results in others, because depending on the position of the global maxima in each replicate, we mean-combined position of the global maximum may substantially differ from that. Considering, for example, a situation where the position values for the global maxima in each replicate in control are 10, 11 and 12, we would continue in our analysis using the mean-combined position of 11, which downstream may indicate that there is an effect when it does not, or, vice versa, wrongly indicates that an effect does not exist when it actually does. Last, our selection criteria were limited in that we approached the issue in a rather rigid, black-and-white approach where a more dynamic definition of RNA-dependence might have been more appropriate. This could include making certain modifications to our selections criteria if certain conditions are met, e.g. modifying the required magnitude of shift in the position of the global maximum if there is a very significant difference in protein amount between control and RNase at that position or allowing for a less significant $p$-value if the position of the global maximum shows a high enough shift.  
...
# **5. References**
Beckmann, B.M., Castello, A., and Medenbach, J. (2016). The expanding universe of ribonucleoproteins: Of novel RNA-binding proteins and unconventional interactions. Pflügers Archiv-European Journal of Physiology _468_, 1029–1040.  

Benjamini, Y., and Hochberg, Y. (1995). Controlling the false discovery rate: A practical and powerful approach to multiple testing. Journal of the Royal Statistical Society: Series B (Methodological) _57_, 289–300.  

Castello, A., Fischer, B., Frese, C.K., Horos, R., Alleaume, A.-M., Foehr, S., Curk, T., Krijgsveld, J., and Hentze, M.W. (2016). Comprehensive identification of RNA-binding domains in human cells. Molecular Cell _63_, 696–710.  

Caudron-Herger, M., Rusin, S.F., Adamo, M.E., Seiler, J., Schmid, V.K., Barreau, E., Kettenbach, A.N., and Diederichs, S. (2019). R-DeeP: Proteome-wide and quantitative identification of RNA-dependent proteins by density gradient ultracentrifugation. Molecular Cell _75_, 184–199.  

Corley, M., Burns, M.C., and Yeo, G.W. (2020). How RNA-binding proteins interact with RNA: Molecules and mechanisms. Molecular Cell _78_, 9–29.  

Faoro, C., and Ataide, S.F. (2021). Noncanonical functions and cellular dynamics of the mammalian signal recognition particle components. Frontiers in Molecular Biosciences _420_.  

Farrell, R.E. (2010). Chapter 2 - RNA isolation strategies. In RNA Methodologies (Fourth Edition), R.E. Farrell, ed. (San Diego: Academic Press), pp. 45–80.  

Gebauer, F., Schwarzl, T., Valcárcel, J., and Hentze, M.W. (2021). RNA-binding proteins in human genetic disease. Nature Reviews Genetics _22_, 185–198.  

Maziuk, B., Ballance, H.I., and Wolozin, B. (2017). Dysregulation of RNA binding protein aggregation in neurode-enerative disorders. Frontiers in Molecular Neuroscience _10_, 89.  

Mullari, M., Lyon, D., Jensen, L.J., and Nielsen, M.L. (2017). Specifying RNA-binding regions in proteins by peptide cross-linking and affinity purification. Journal of Proteome Research _16_, 2762–2772.  

Pratt, A.J., and MacRae, I.J. (2009). The RNA-induced silencing complex: A versatile gene-silencing machine. Journal of Biological Chemistry _284_, 17897–17901.  

Raschke, S., Guan, J., and Iliakis, G. (2009). Application of alkaline sucrose gradient centrifugation in the analysis of DNA replication after DNA damage. In DNA Replication, (Springer), pp. 329–342.  

Urdaneta, E.C., Vieira-Vieira, C.H., Hick, T., Wessels, H.-H., Figini, D., Moschall, R., Medenbach, J., Ohler, U., Granneman, S., Selbach, M., et al. (2019). Purification of cross-linked RNA-protein complexes by phenol-toluol extraction. Nature Communications _10_, 1–17.  

Zhang, B., Babu, K.R., Lim, C.Y., Kwok, Z.H., Li, J., Zhou, S., Yang, H., and Tay, Y. (2020). A comprehensive expression landscape of RNA-binding proteins (RBPs) across 16 human cancer types. RNA Biology _17_, 211–226.
