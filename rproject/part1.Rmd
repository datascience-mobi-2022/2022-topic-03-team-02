...
df_plot1 <- data.frame(x = tdf_normalized$K2C1_HUMAN[76:100], y = tdf_normalized$K2C1_HUMAN[126:150])
ggplot(df_plot1, aes(x, y)) +
  geom_point() +
  geom_smooth()
```
```{r}
...
df_plot2 <- data.frame(x = tdf_normalized$ECE1_HUMAN[1:25] , y = tdf_normalized$ECE1_HUMAN[26:50])
