...
We can save this data frame as a new file **RDeeP_HeLa_Mitosis_normalized.csv**:

```{r}
#write.csv(df_normalized, "RDeeP_HeLa_Mitosis_normalized.csv", row.names = TRUE)
```

```{r}
#df_normalized1 <- read.table("RDeeP_HeLa_Mitosis_normalized.csv", header = TRUE, row.names = 1, sep = ",")
#sum(df_normalized[1,]) / 6 == 100
```
